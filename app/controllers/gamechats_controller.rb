class GamechatsController < ApplicationController
  ...
  def create
    ...
    if @gamechat.save
      ...
      Gamechat.where(:game_id => params[:gamechat][:game_id])
        .destroy_all(['id NOT IN (?)', Gamechat.last(25)])
    end
  end

  protected

  def emoji #first strip img tags from ne'erdowell chatters
  params[:gamechat][:message].sub!("<img", "") #then see if they want to use emoji
  allemoji = ["-1", "+1", "8ball", "100", "109", "1234", "a", "ab", "abc",
  "abcd", "accept", "aerial_tramway", "airplane", "alarm_clock", "alien",
  "ambulance", "anchor", "angel", "anger", "angry", "anguished", "ant", "apple",
  "aquarius", "aries", "arrow_backward", "arrow_double_down", "arrow_double_up",
  ...
  "astonished", "atm", "b", "baby", "baby_bottle", "baby_chick", "baby_symbol",
  "back", "baggage_claim", "balloon", "ballot_box_with_check", "bamboo",
  "banana", "bangbang", "bank", "barber", "bar_chart", "baseball", "basketball",
  "bath", "bathtub", "battery", "bear", "bee", "beer", "beers", "beetle",
  "beginner", "bell", "bento", "bicyclist", "bike", "bikini", "bird",
  "birthday", "black_circle", "black_joker", "black_medium_small_square",
  ...
  "clipboard", "clock1", "clock2", "clock3", "clock4", "clock5", "clock6",
  "clock7", "clock8", "clock9", "clock10", "clock11", "clock12", "clock130",
  "clock230", "clock330", "clock430", "clock530", "clock630", "clock730",
  "clock830", "clock930", "clock1030", "clock1130", "clock1230", "closed_book",
  "closed_lock_with_key", "closed_umbrella", "cloud", "clubs", "cn", "cocktail",
  "coffee", "cold_sweat", "collision", "computer", "confetti_ball",
  "confounded", "confused", "congratulations", "construction",
  "construction_worker", "convenience_store", "cookie", "cool", "cop",
  "copyright", "corn", "couple", "couplekiss", "couple_with_heart", "cow",
  "cow2", "credit_card", "crocodile", "crossed_flags", "crown", "cry",
  "crying_cat_face", "crystal_ball", "cupid", "curly_loop", "currency_exchange",
  "curry", "custard", "customs", "cyclone", "dancer", "dancers", "dango",
  "dart", "dash", "date", "de", "deciduous_tree", "department_store",
  "diamonds", "diamond_shape_with_a_dot_inside", "disappointed",
  "disappointed_relieved", "dizzy", "dizzy_face", "dog", "dog2", "dollar",
  "dolls", "dolphin", "do_not_litter", "donut", "door", "doughnut", "dragon",
  "dragon_face", "dress", "dromedary_camel", "droplet", "dvd", "ear",
  "ear_of_rice", "earth_africa", "earth_americas", "earth_asia", "egg",
  "eggplant", "eight", "eight_pointed_black_star", "eight_spoked_asterisk",
  "electric_plug", "elephant", "email", "e-mail", "emojify.css end", "envelope",
  "es", "euro", "european_castle", "european_post_office", "evergreen_tree",
  "exclamation", "expressionless", "eyeglasses", "eyes", "facepunch", "factory",
  ...
  "gift_heart", "girl", "globe_with_meridians", "goat", "goberserk", "godmode",
  ...
  "heavy_minus_sign", "heavy_multiplication_x", "heavy_plus_sign", "helicopter",
  "herb", "hibiscus", "high_brightness", "high_heel", "hocho", "honeybee",
  "honey_pot", "horse", "horse_racing", "hospital", "hotel", "hotsprings",
  "hourglass", "hourglass_flowing_sand", "house", "house_with_garden",
  "hurtrealbad", "hushed", "icecream", "ice_cream", "id", "ideograph_advantage",
  "imp", "inbox_tray", "incoming_envelope", "information_desk_person",
  "information_source", "innocent", "interrobang", "iphone", "it",
  "izakaya_lantern", "jack_o_lantern", "japan", "japanese_castle",
  "japanese_goblin", "japanese_ogre", "jeans", "joy", "joy_cat", "jp", "key",
  "keycap_ten", "kimono", "kiss", "kissing", "kissing_cat",
  "kissing_closed_eyes", "kissing_face", "kissing_heart",
  ...
  "monorail", "moon", "mortar_board", "mountain_bicyclist", "mountain_cableway",
  "mountain_railway", "mount_fuji", "mouse", "mouse2", "movie_camera", "moyai",
  "muscle", "mushroom", "musical_keyboard", "musical_note", "musical_score",
  "mute", "nail_care", "name_badge", "neckbeard", "necktie",
  "negative_squared_cross_mark", "neutral_face", "new", "new_moon",
  "new_moon_with_face", "newspaper", "ng", "nine", "no_bell", "no_bicycles",
  "no_entry", "no_entry_sign", "no_good", "no_mobile_phones", "no_mouth", "non-
  potable_water", "no_pedestrians", "nose", "no_smoking", "notebook",
  ...
  "package", "page_facing_up", "pager", "page_with_curl", "palm_tree",
  "panda_face", "paperclip", "parking", "part_alternation_mark", "partly_sunny",
  ...
  "poop", "postal_horn", "postbox", "post_office", "potable_water", "pouch",
  ...
  "scroll", "seat", "secret", "seedling", "see_no_evil", "seven", "shaved_ice",
  ...
  "sparkler", "sparkles", "sparkling_heart", "speaker", "speak_no_evil",
  ...
  "stuck_out_tongue_winking_eye", "sunflower", "sunglasses", "sunny", "sunrise",
  "sunrise_over_mountains", "sun_with_face", "surfer", "sushi", "suspect",
  ...
  "two_women_holding_hands", "u6e80", "u7a7a", "u55b6", "u5272", "u5408",
  "u6307", "u6708", "u6709", "u7121", "u7533", "u7981", "uk", "umbrella",
  ...
  "white_square_button", "wind_chime", "wine_glass", "wink", "wink2", "wolf",
  "woman", "womans_clothes", "womans_hat", "womens", "worried", "wrench", "x",
  "yellow_heart", "yen", "yum", "zap", "zero", "zzz"]

  allemoji.each do |emo|
    @emojipic = '<img class="emoji" src="/assets/emoji/' + emo + '.png">'
    params[:gamechat][:message].sub!(":" + emo + ":", "#{ @emojipic }")
  end

  #special emoji
  params[:gamechat][:message].sub!(":)", '<img class="emoji" src="/assets/emoji/smiley.png">')
  params[:gamechat][:message].sub!(":-)", '<img class="emoji" src="/assets/emoji/smiley.png">')
  params[:gamechat][:message].sub!(":(", '<img class="emoji" src="/assets/emoji/frowning.png">')
  params[:gamechat][:message].sub!(":-(", '<img class="emoji" src="/assets/emoji/frowning.png">')
  params[:gamechat][:message].sub!(":D", '<img class="emoji" src="/assets/emoji/smile.png">')
  params[:gamechat][:message].sub!(":-D", '<img class="emoji" src="/assets/emoji/smile.png">')
  params[:gamechat][:message].sub!("<3", '<img class="emoji" src="/assets/emoji/heart.png">')
  ...
  private
    ...
    def gamechat_params
      params.require(:gamechat).permit(:message, :game_id, :user_id)
    end
end
